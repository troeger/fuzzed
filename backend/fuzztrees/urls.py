...
urlpatterns = patterns('',
	...
	url(r'^api/graphs/(?P<graph_id>\d+)/nodes/(?P<node_id>\d+)/edges$','fuzztrees.api.node.edges', name='edges'),
	url(r'^api/graphs/(?P<graph_id>\d+)/nodes/(?P<node_id>\d+)/edges/(?P<edge_id>\d+)$','fuzztrees.api.node.edge', name='edge'),
