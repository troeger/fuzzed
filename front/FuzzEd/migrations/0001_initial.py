...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('FuzzEd_project', (
        ...
        m2m_table_name = db.shorten_name('FuzzEd_project_users')
        ...
        db.create_table('FuzzEd_sharing', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.create_table('FuzzEd_configuration', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.create_table('FuzzEd_nodeconfiguration', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.create_table('FuzzEd_nodegroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('client_id', self.gf('django.db.models.fields.BigIntegerField')(default=-2147483647)),
        ...
        m2m_table_name = db.shorten_name('FuzzEd_nodegroup_nodes')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
        ...
        db.create_table('FuzzEd_addproject', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.create_table('FuzzEd_changeedge', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('undoable', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('insert_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('edge', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['FuzzEd.Edge'])),
        ...
        db.create_table('FuzzEd_edgepropertychange', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.create_table('FuzzEd_deleteproject', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('undoable', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('insert_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['FuzzEd.Project'])),
        ...
        db.create_table('FuzzEd_notification', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        m2m_table_name = db.shorten_name('FuzzEd_notification_users')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('FuzzEd_configuration')

        # Deleting model 'NodeConfiguration'
        db.delete_table('FuzzEd_nodeconfiguration')

        # Deleting model 'Result'
        db.delete_table('FuzzEd_result')

        # Deleting model 'Job'
        db.delete_table('FuzzEd_job')

        # Deleting model 'NodeGroup'
        db.delete_table('FuzzEd_nodegroup')

        # Removing M2M table for field nodes on 'NodeGroup'
        db.delete_table(db.shorten_name('FuzzEd_nodegroup_nodes'))

        # Deleting model 'Property'
        db.delete_table('FuzzEd_property')

        # Deleting model 'AddProject'
        db.delete_table('FuzzEd_addproject')
        ...
        db.delete_table('FuzzEd_deleteproject')
        ...
        db.delete_table('FuzzEd_notification')

        # Removing M2M table for field users on 'Notification'
        db.delete_table(db.shorten_name('FuzzEd_notification_users'))
    ...
    models = {
        ...
        'FuzzEd.project': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'own_projects'", 'to': "orm['auth.User']"}),
        ...
        'FuzzEd.sharing': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sharings'", 'to': "orm['auth.User']"})
        },
        'FuzzEd.userprofile': {
