...
# Generated 2018-03-13 20:23:23.641208 by PyXB version 1.2.6 using Python 3.5.2.final.0
...
class Choice (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/configurations.xsd', 7, 2)
    _ElementMap = {}
    _AttributeMap = {}
...
class IntegerToChoiceMap (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/configurations.xsd', 9, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element value uses Python identifier value_
    __value = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'value'), 'value_', '__httpwww_fuzzed_orgconfigurations_IntegerToChoiceMap_value', False, pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/configurations.xsd', 11, 6), )
    ...
    __key._DeclarationLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/configurations.xsd', 13, 4)
    __key._UseLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/configurations.xsd', 13, 4)
...
class Configuration (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/configurations.xsd', 16, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element choice uses Python identifier choice
    __choice = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'choice'), 'choice', '__httpwww_fuzzed_orgconfigurations_Configuration_choice', True, pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/configurations.xsd', 18, 6), )
    ...
    __id._DeclarationLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/configurations.xsd', 20, 4)
    __id._UseLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/configurations.xsd', 20, 4)
    ...
    __costs._DeclarationLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/configurations.xsd', 21, 4)
    __costs._UseLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/configurations.xsd', 21, 4)
...
class InclusionChoice (Choice):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/configurations.xsd', 24, 2)
    ...
    __included._DeclarationLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/configurations.xsd', 27, 8)
    __included._UseLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/configurations.xsd', 27, 8)
...
class RedundancyChoice (Choice):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/configurations.xsd', 32, 2)
    _ElementMap = Choice._ElementMap.copy()
    _AttributeMap = Choice._AttributeMap.copy()
    # Base type is Choice
    ...
    __n._DeclarationLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/configurations.xsd', 35, 8)
    __n._UseLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/configurations.xsd', 35, 8)
...
class FeatureChoice (Choice):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/configurations.xsd', 40, 2)
    _ElementMap = Choice._ElementMap.copy()
    _AttributeMap = Choice._AttributeMap.copy()
    # Base type is Choice
    ...
    __featureId._DeclarationLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/configurations.xsd', 43, 8)
    __featureId._UseLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/configurations.xsd', 43, 8)
...
class TransferInChoice (Choice):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/configurations.xsd', 48, 2)
    _ElementMap = Choice._ElementMap.copy()
    _AttributeMap = Choice._AttributeMap.copy()
    # Base type is Choice
    
    # Element chosenConfiguration uses Python identifier chosenConfiguration
    __chosenConfiguration = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'chosenConfiguration'), 'chosenConfiguration', '__httpwww_fuzzed_orgconfigurations_TransferInChoice_chosenConfiguration', False, pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/configurations.xsd', 52, 10), )
...
IntegerToChoiceMap._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'value'), Choice, scope=IntegerToChoiceMap, location=pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/configurations.xsd', 11, 6)))
...
def _BuildAutomaton ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(IntegerToChoiceMap._UseForTag(pyxb.namespace.ExpandedName(None, 'value')), pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/configurations.xsd', 11, 6))
...
Configuration._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'choice'), IntegerToChoiceMap, scope=Configuration, location=pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/configurations.xsd', 18, 6)))
...
def _BuildAutomaton_ ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/configurations.xsd', 18, 6))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(Configuration._UseForTag(pyxb.namespace.ExpandedName(None, 'choice')), pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/configurations.xsd', 18, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
...
TransferInChoice._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'chosenConfiguration'), Configuration, scope=TransferInChoice, location=pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/configurations.xsd', 52, 10)))
...
def _BuildAutomaton_2 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(TransferInChoice._UseForTag(pyxb.namespace.ExpandedName(None, 'chosenConfiguration')), pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/configurations.xsd', 52, 10))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    st_0._set_transitionSet(transitions)
