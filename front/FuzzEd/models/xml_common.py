# front/FuzzEd/models/xml_common.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:048f94face6649912cf7a695fb6b859022492725
# Generated 2018-03-13 20:23:23.636367 by PyXB version 1.2.6 using Python 3.5.2.final.0
...
class idList (pyxb.binding.basis.STD_list):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 26, 2)
    _Documentation = None
...
class Model (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 11, 2)
    _ElementMap = {}
    _AttributeMap = {}
    ...
    __id._DeclarationLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 13, 4)
    __id._UseLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 13, 4)
...
class GraphNode (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 17, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __x._DeclarationLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 19, 4)
    __x._UseLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 19, 4)
    ...
    __y._DeclarationLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 20, 4)
    __y._UseLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 20, 4)
    ...
    __id._DeclarationLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 22, 4)
    __id._UseLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 22, 4)
...
class DoubleToIntervalMap (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 31, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element value uses Python identifier value_
    __value = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'value'), 'value_', '__httpwww_fuzzed_orgcommonTypes_DoubleToIntervalMap_value', False, pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 33, 6), )
    ...
    __key._DeclarationLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 35, 4)
    __key._UseLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 35, 4)
...
class Interval (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 38, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __lowerBound._DeclarationLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 39, 4)
    __lowerBound._UseLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 39, 4)
    ...
    __upperBound._DeclarationLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 40, 4)
    __upperBound._UseLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 40, 4)
...
class Issue (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 43, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __issueId._DeclarationLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 44, 6)
    __issueId._UseLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 44, 6)
    ...
    __elementId._DeclarationLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 45, 6)
    __elementId._UseLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 45, 6)
    ...
    __message._DeclarationLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 46, 6)
    __message._UseLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 46, 6)
    ...
    __isFatal._DeclarationLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 47, 6)
    __isFatal._UseLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 47, 6)
...
class Probability (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 51, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    _ElementMap.update({
...
class CrispProbability (Probability):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 53, 2)
    ...
    __val._DeclarationLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 56, 8)
    __val._UseLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 56, 8)
...
class DecomposedFuzzyProbability (Probability):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 61, 2)
    _ElementMap = Probability._ElementMap.copy()
    _AttributeMap = Probability._AttributeMap.copy()
    # Base type is Probability
    
    # Element alphaCuts uses Python identifier alphaCuts
    __alphaCuts = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'alphaCuts'), 'alphaCuts', '__httpwww_fuzzed_orgcommonTypes_DecomposedFuzzyProbability_alphaCuts', True, pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 65, 10), )
...
DoubleToIntervalMap._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'value'), Interval, scope=DoubleToIntervalMap, location=pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 33, 6)))
...
def _BuildAutomaton ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(DoubleToIntervalMap._UseForTag(pyxb.namespace.ExpandedName(None, 'value')), pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 33, 6))
...
DecomposedFuzzyProbability._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'alphaCuts'), DoubleToIntervalMap, scope=DecomposedFuzzyProbability, location=pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 65, 10)))
...
def _BuildAutomaton_ ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 65, 10))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(DecomposedFuzzyProbability._UseForTag(pyxb.namespace.ExpandedName(None, 'alphaCuts')), pyxb.utils.utility.Location('/ore/front/FuzzEd/static/xsd/commonTypes.xsd', 65, 10))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
