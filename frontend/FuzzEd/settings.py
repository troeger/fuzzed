...
class Common(Configuration):
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': values.Value('fuzzed', environ_name='DB_NAME', environ_prefix='ORE'),
            'USER': values.Value('fuzzed', environ_name='DB_USER', environ_prefix='ORE'),
            'PASSWORD': values.Value('fuzzed', environ_name='DB_PASSWORD', environ_prefix='ORE'),
    ...
    FEEDBACK_PAGE = values.URLValue(
        'http://fuzzed.uservoice.com', environ_prefix='ORE')
