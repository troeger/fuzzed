...
namespace faulttree
{
  ...
  const TopEvent::MissionTimeOptional& TopEvent::
  missionTime () const
  {
    return this->missionTime_;
  }

  TopEvent::MissionTimeOptional& TopEvent::
  missionTime ()
  {
    return this->missionTime_;
  }
  ...
  const TopEvent::DecompositionNumberOptional& TopEvent::
  decompositionNumber () const
  {
    return this->decompositionNumber_;
  }

  TopEvent::DecompositionNumberOptional& TopEvent::
  decompositionNumber ()
  {
    return this->decompositionNumber_;
  }
...
namespace faulttree
{
  ...
  operator= (const AnnotatedElement& x)
  {
    if (this != &x)
    {
      ...
      this->annotations_ = x.annotations_;
      this->id_ = x.id_;
      this->name_ = x.name_;
    }
  ...
  operator= (const Node& x)
  {
    if (this != &x)
    {
      static_cast< ::faulttree::AnnotatedElement& > (*this) = x;
  ...
  FaultTree& FaultTree::
  operator= (const FaultTree& x)
  {
    if (this != &x)
    {
      static_cast< ::faulttree::Model& > (*this) = x;
      this->topEvent_ = x.topEvent_;
    }
  ...
  operator= (const TopEvent& x)
  {
    if (this != &x)
    {
      static_cast< ::faulttree::Node& > (*this) = x;
      this->missionTime_ = x.missionTime_;
  ...
  operator= (const CrispProbability& x)
  {
    if (this != &x)
    {
      static_cast< ::faulttree::Probability& > (*this) = x;
  ...
  operator= (const VotingOr& x)
  {
    if (this != &x)
    {
      static_cast< ::faulttree::Gate& > (*this) = x;
      this->k_ = x.k_;
    }
  ...
  : ::faulttree::ChildNode (id),
    fromModelId_ (fromModelId, this),
    maxCosts_ (maxCostsDefaultValue (), this)
  {
  }
  ...
  operator= (const TransferIn& x)
  {
    if (this != &x)
    {
      static_cast< ::faulttree::ChildNode& > (*this) = x;
      this->fromModelId_ = x.fromModelId_;
      this->maxCosts_ = x.maxCosts_;
    }
  ...
  BasicEventSet (const ::xercesc::DOMElement& e,
                 ::xml_schema::Flags f,
                 ::xml_schema::Container* c)
  : ::faulttree::BasicEvent (e, f | ::xml_schema::Flags::base, c),
    quantity_ (this)
  {
    if ((f & ::xml_schema::Flags::base) == 0)
    {
  ...
  parse (::xsd::cxx::xml::dom::parser< char >& p,
         ::xml_schema::Flags f)
  {
    this->::faulttree::BasicEvent::parse (p, f);
  ...
  operator= (const BasicEventSet& x)
  {
    if (this != &x)
    {
      static_cast< ::faulttree::BasicEvent& > (*this) = x;
  ...
  : ::faulttree::IntermediateEvent (id),
    quantity_ (this)
  {
  }
  ...
  IntermediateEventSet (const IntermediateEventSet& x,
                        ::xml_schema::Flags f,
                        ::xml_schema::Container* c)
  : ::faulttree::IntermediateEvent (x, f, c),
    quantity_ (x.quantity_, f, this)
  {
  }
  ...
  IntermediateEventSet (const ::xercesc::DOMElement& e,
                        ::xml_schema::Flags f,
                        ::xml_schema::Container* c)
  : ::faulttree::IntermediateEvent (e, f | ::xml_schema::Flags::base, c),
    quantity_ (this)
  {
    if ((f & ::xml_schema::Flags::base) == 0)
    {
  ...
  parse (::xsd::cxx::xml::dom::parser< char >& p,
         ::xml_schema::Flags f)
  {
    this->::faulttree::IntermediateEvent::parse (p, f);
  ...
  operator= (const IntermediateEventSet& x)
  {
    if (this != &x)
    {
      static_cast< ::faulttree::IntermediateEvent& > (*this) = x;
      this->quantity_ = x.quantity_;
    }
  ...
  : ::faulttree::DynamicGate (id),
    ...
    dormancyFactor_ (dormancyFactor, this)
  {
  }
         ...
         ::xml_schema::Flags f)
  {
    ...
    while (p.more_attributes ())
    {
      ...
      {
        this->primaryID_.set (PrimaryIDTraits::create (i, f, this));
        continue;
      }
  ...
  Spare& Spare::
  operator= (const Spare& x)
  {
    if (this != &x)
    {
      static_cast< ::faulttree::DynamicGate& > (*this) = x;
      this->primaryID_ = x.primaryID_;
      this->dormancyFactor_ = x.dormancyFactor_;
    }
  ...
  : ::faulttree::DynamicGate (id),
    eventSequence_ (eventSequence, this)
  {
  }
         ...
         ::xml_schema::Flags f)
  {
    ...
    while (p.more_attributes ())
    {
      ...
      {
        this->eventSequence_.set (EventSequenceTraits::create (i, f, this));
        continue;
      }
    }
  ...
  PriorityAnd& PriorityAnd::
  operator= (const PriorityAnd& x)
  {
    if (this != &x)
    {
      static_cast< ::faulttree::DynamicGate& > (*this) = x;
      this->eventSequence_ = x.eventSequence_;
    }
  ...
  : ::faulttree::DynamicGate (id),
    ...
    triggeredEvents_ (triggeredEvents, this)
  {
  }
         ...
         ::xml_schema::Flags f)
  {
    ...
    while (p.more_attributes ())
    {
      ...
      {
        this->trigger_.set (TriggerTraits::create (i, f, this));
        continue;
      }

      if (n.name () == "triggeredEvents" && n.namespace_ ().empty ())
      {
        this->triggeredEvents_.set (TriggeredEventsTraits::create (i, f, this));
        continue;
      }
    }
  ...
  FDEP& FDEP::
  operator= (const FDEP& x)
  {
    if (this != &x)
    {
      static_cast< ::faulttree::DynamicGate& > (*this) = x;
      this->trigger_ = x.trigger_;
      this->triggeredEvents_ = x.triggeredEvents_;
    }
...
namespace faulttree
{
             ...
             const ::xml_schema::Properties& p)
  {
    ...
    return ::std::auto_ptr< ::faulttree::FaultTree > (
      ::faulttree::faultTree (
  ...
  ::std::auto_ptr< ::faulttree::FaultTree >
  faultTree (const ::xercesc::DOMDocument& doc,
             ::xml_schema::Flags f,
             const ::xml_schema::Properties& p)
  {
...
namespace faulttree
{
  ...
  {
    e << static_cast< const ::faulttree::IntermediateEvent& > (i);
