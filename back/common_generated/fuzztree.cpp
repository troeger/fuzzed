...
namespace fuzztree
{
  ...
  operator= (const Node& x)
  {
    if (this != &x)
    {
      static_cast< ::fuzztree::AnnotatedElement& > (*this) = x;
  ...
  operator= (const FuzzTree& x)
  {
    if (this != &x)
    {
      static_cast< ::fuzztree::Model& > (*this) = x;
  ...
  operator= (const TopEvent& x)
  {
    if (this != &x)
    {
      static_cast< ::fuzztree::Node& > (*this) = x;
  ...
  operator= (const CrispProbability& x)
  {
    if (this != &x)
    {
      static_cast< ::fuzztree::Probability& > (*this) = x;
  ...
  operator= (const VotingOr& x)
  {
    if (this != &x)
    {
      static_cast< ::fuzztree::Gate& > (*this) = x;
      this->k_ = x.k_;
    }
  ...
  operator= (const TransferIn& x)
  {
    if (this != &x)
    {
      static_cast< ::fuzztree::VariationPoint& > (*this) = x;
  ...
  : ::fuzztree::VariationPoint (id),
    optional_ (optionalDefaultValue (), this),
    costs_ (this)
  {
  }
  ...
  operator= (const BasicEvent& x)
  {
    if (this != &x)
    {
      static_cast< ::fuzztree::InclusionVariationPoint& > (*this) = x;
  ...
  operator= (const BasicEventSet& x)
  {
    if (this != &x)
    {
      static_cast< ::fuzztree::BasicEvent& > (*this) = x;
  ...
  operator= (const IntermediateEventSet& x)
  {
    if (this != &x)
    {
      static_cast< ::fuzztree::IntermediateEvent& > (*this) = x;
      this->quantity_ = x.quantity_;
    }
         ...
         ::xml_schema::Flags f)
  {
    ...
    while (p.more_attributes ())
    {
      ...
      {
        this->formula_.set (FormulaTraits::create (i, f, this));
        continue;
      }
    }
...
namespace fuzztree
{
            ...
            const ::xml_schema::Properties& p)
  {
    ...
    return ::std::auto_ptr< ::fuzztree::FuzzTree > (
      ::fuzztree::fuzzTree (
  ...
  ::std::auto_ptr< ::fuzztree::FuzzTree >
  fuzzTree (const ::xercesc::DOMDocument& doc,
            ::xml_schema::Flags f,
            const ::xml_schema::Properties& p)
  {
