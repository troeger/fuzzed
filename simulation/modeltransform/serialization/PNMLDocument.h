...
public:
	...
	virtual void addSequenceConstraint(const vector<int>& sequence, SequenceType type) override;
...
protected:
	...
	int addTransition(long double rate, bool isTimed, const string& label = "");
