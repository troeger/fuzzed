...
public:
	...
	virtual int addTimedTransition(long double rate, const Condition& cond = Condition()) override;
	virtual int addImmediateTransition(long double weight = 1.0, const Condition& cond = Condition()) override;
...
protected:
	...
	int addTransition(long double rate, const Condition& cond, bool isTimed);
