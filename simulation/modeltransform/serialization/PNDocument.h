...
public:
	...
	virtual int addTimedTransition(long double rate, const Condition& cond = Condition()) = 0;
	virtual int addImmediateTransition(long double weight = 1.0, const Condition& cond = Condition()) = 0;
