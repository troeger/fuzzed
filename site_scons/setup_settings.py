...
def createDjangoDevSettings(target, source, env):
    for t in target:
        f=open(str(t),'w')
        f.write(createDjangoSettings('settings.ini', ['development']))
        f.close()

def createDjangoVagrantSettings(target, source, env):
    for t in target:
        f=open(str(t),'w')
        f.write(createDjangoSettings('settings.ini', ['vagrant']))
        f.close()

def createDjangoProdSettings(target, source, env):
    for t in target:
        f=open(str(t),'w')
        f.write(createDjangoSettings('settings.ini', ['production']))
      f.close()
