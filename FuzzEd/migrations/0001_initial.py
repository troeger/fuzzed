...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'FuzzEd_job', (
            ...
            ('secret', self.gf('django.db.models.fields.CharField')(default='9aac8e64-82cc-4ae0-9c40-3544ba7cbda8', max_length=64)),
            ('kind', self.gf('django.db.models.fields.CharField')(max_length=127)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
    ...
    models = {
        ...
        'FuzzEd.job': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'kind': ('django.db.models.fields.CharField', [], {'max_length': '127'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'28e671e4-5d22-4836-8a98-0c8744b7f77e'", 'max_length': '64'})
        },
        'FuzzEd.node': {
