...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Job.binary_result'
        db.add_column(u'FuzzEd_job', 'binary_result',
                      self.gf('django.db.models.fields.BinaryField')(null=True),
                      keep_default=False)

        # Adding field 'Job.text_result'
        db.add_column(u'FuzzEd_job', 'text_result',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Job.binary_result'
        db.delete_column(u'FuzzEd_job', 'binary_result')

        # Deleting field 'Job.text_result'
        db.delete_column(u'FuzzEd_job', 'text_result')
    ...
    models = {
        ...
        'FuzzEd.job': {
            ...
            'binary_result': ('django.db.models.fields.BinaryField', [], {'null': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'text_result': ('django.db.models.fields.TextField', [], {'null': 'True'})
        },
        'FuzzEd.node': {
