...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PropertyChange.old_value'
        db.alter_column(u'FuzzEd_propertychange', 'old_value', self.gf('FuzzEd.lib.jsonfield.fields.JSONField')())

        # Changing field 'PropertyChange.new_value'
        db.alter_column(u'FuzzEd_propertychange', 'new_value', self.gf('FuzzEd.lib.jsonfield.fields.JSONField')())

    def backwards(self, orm):

        # Changing field 'PropertyChange.old_value'
        db.alter_column(u'FuzzEd_propertychange', 'old_value', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'PropertyChange.new_value'
        db.alter_column(u'FuzzEd_propertychange', 'new_value', self.gf('django.db.models.fields.CharField')(max_length=255))
