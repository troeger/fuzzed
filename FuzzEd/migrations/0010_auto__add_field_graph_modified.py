...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Graph.modified'
        db.add_column(u'FuzzEd_graph', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 11, 3, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Graph.modified'
        db.delete_column(u'FuzzEd_graph', 'modified')
    ...
    models = {
        ...
        'FuzzEd.job': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'19285437-4874-4706-9aad-13f08da8c046'", 'max_length': '64'})
        },
        'FuzzEd.node': {
