...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NodeGroup.graph'
        db.add_column(u'FuzzEd_nodegroup', 'graph',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='groups', to=orm['FuzzEd.Graph']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NodeGroup.graph'
        db.delete_column(u'FuzzEd_nodegroup', 'graph_id')
    ...
    models = {
        ...
        'FuzzEd.job': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'3c85e343-15e1-4e90-9dea-a7a5a59c1b8e'", 'max_length': '64'})
        },
        'FuzzEd.node': {
