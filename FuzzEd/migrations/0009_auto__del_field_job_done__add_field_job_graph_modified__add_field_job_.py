...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Job.graph_modified'
        db.add_column(u'FuzzEd_job', 'graph_modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 11, 3, 0, 0)),
                      keep_default=False)

        # Adding field 'Job.exit_code'
        db.add_column(u'FuzzEd_job', 'exit_code',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Job.graph_modified'
        db.delete_column(u'FuzzEd_job', 'graph_modified')

        # Deleting field 'Job.exit_code'
        db.delete_column(u'FuzzEd_job', 'exit_code')
    ...
    models = {
        ...
        'FuzzEd.job': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'de3cd1c3-7acc-48d5-b4fc-b7c38d9f3076'", 'max_length': '64'})
        },
        'FuzzEd.node': {
