...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'FuzzEd_configuration', (
            ...
            ('graph', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['FuzzEd.Graph'])),
        ...
        db.create_table(u'FuzzEd_nodeconfiguration', (
            ...
            ('setting', self.gf('django.db.models.fields.TextField')()),
        ...
        db.create_table(u'FuzzEd_result', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('configuration', self.gf('django.db.models.fields.related.ForeignKey')(related_name='result', to=orm['FuzzEd.Configuration'])),
            ('graph', self.gf('django.db.models.fields.related.ForeignKey')(related_name='results', to=orm['FuzzEd.Graph'])),
            ('analysis_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('prob', self.gf('django.db.models.fields.TextField')()),
            ('prob_sortable', self.gf('django.db.models.fields.IntegerField')()),
            ('decomposition', self.gf('django.db.models.fields.IntegerField')()),
            ('issues', self.gf('django.db.models.fields.TextField')()),
            ('rounds', self.gf('django.db.models.fields.IntegerField')()),
            ('failures', self.gf('django.db.models.fields.IntegerField')()),
        ))
    ...
    models = {
        ...
        'FuzzEd.configuration': {
            ...
            'graph': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['FuzzEd.Graph']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'FuzzEd.deleteedge': {
        ...
        'FuzzEd.job': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'a1721eb9-2534-449f-bbfc-dd7e783401ad'", 'max_length': '64'})
        },
        'FuzzEd.node': {
        ...
        'FuzzEd.nodeconfiguration': {
            ...
            'setting': ('django.db.models.fields.TextField', [], {})
        },
        'FuzzEd.notification': {
        ...
        'FuzzEd.result': {
            ...
            'analysis_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'configuration': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'result'", 'to': "orm['FuzzEd.Configuration']"}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issues': ('django.db.models.fields.TextField', [], {}),
            'prob': ('django.db.models.fields.TextField', [], {}),
            'prob_sortable': ('django.db.models.fields.IntegerField', [], {}),
