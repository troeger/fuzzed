...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'FuzzEd_job', 'result', self.gf('django.db.models.fields.BinaryField')(null=True))

    def backwards(self, orm):

        # Changing field 'Job.result'
        db.alter_column(u'FuzzEd_job', 'result', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
    ...
    models = {
        ...
        'FuzzEd.job': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'64c58679-72a6-4747-9b73-40cb4b9422a4'", 'max_length': '64'})
        },
        'FuzzEd.node': {
