...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'FuzzEd_job', 'name')

        # Adding field 'Job.secret'
        db.add_column(u'FuzzEd_job', 'secret',
                      self.gf('django.db.models.fields.CharField')(default='13d279de-6b90-47ab-8c00-fbf9a102f853', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Job.name'
        db.add_column(u'FuzzEd_job', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Deleting field 'Job.secret'
        db.delete_column(u'FuzzEd_job', 'secret')
    ...
    models = {
        ...
        'FuzzEd.job': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'13d279de-6b90-47ab-8c00-fbf9a102f853'", 'max_length': '64'})
        },
        'FuzzEd.node': {
