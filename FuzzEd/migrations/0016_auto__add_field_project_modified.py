...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'FuzzEd_project', 'modified',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'FuzzEd_project', 'modified')
    ...
    models = {
        ...
        'FuzzEd.job': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'51b2c1ee-c45d-47bf-ba2b-8954f5706c34'", 'max_length': '64'})
        },
        'FuzzEd.node': {
