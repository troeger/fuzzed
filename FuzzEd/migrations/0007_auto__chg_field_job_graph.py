...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.graph'
        db.alter_column(u'FuzzEd_job', 'graph_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['FuzzEd.Graph']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Job.graph'
        raise RuntimeError("Cannot reverse this migration. 'Job.graph' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Job.graph'
        db.alter_column(u'FuzzEd_job', 'graph_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['FuzzEd.Graph']))
