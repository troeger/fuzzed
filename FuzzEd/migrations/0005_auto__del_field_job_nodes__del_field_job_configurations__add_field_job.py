...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Job.nodes'
        db.delete_column(u'FuzzEd_job', 'nodes')

        # Deleting field 'Job.configurations'
        db.delete_column(u'FuzzEd_job', 'configurations')

        # Adding field 'Job.done'
        db.add_column(u'FuzzEd_job', 'done',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Job.data'
        db.add_column(u'FuzzEd_job', 'data',
                      self.gf('FuzzEd.models.job.NativeXmlField')(null=True),
                      keep_default=False)


        # Changing field 'Job.name'
        db.alter_column(u'FuzzEd_job', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # Adding field 'Job.nodes'
        db.add_column(u'FuzzEd_job', 'nodes',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Job.configurations'
        db.add_column(u'FuzzEd_job', 'configurations',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Job.done'
        db.delete_column(u'FuzzEd_job', 'done')

        # Deleting field 'Job.data'
        db.delete_column(u'FuzzEd_job', 'data')
        ...
        # Changing field 'Job.name'
        db.alter_column(u'FuzzEd_job', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        'FuzzEd.job': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'data': ('FuzzEd.models.job.NativeXmlField', [], {'null': 'True'}),
            'done': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'graph': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'jobs'", 'to': "orm['FuzzEd.Graph']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'kind': ('django.db.models.fields.CharField', [], {'max_length': '127'}),
