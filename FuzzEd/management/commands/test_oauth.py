...
# This means transporting the client_secret readable, which would
# obviousely be a very stupid idea in production code.
import os
os.environ['DEBUG'] = '1'
...
class Command(BaseCommand):
    # Make sure that client_id and client_secret are registered for
