...
urlpatterns = patterns('',
    ...
    url(r'^api/graphs/(?P<graph_id>\d+)/nodes/(?P<node_id>\d+)/edges$','FuzzEd.api.edges', name='edges'),
    url(r'^api/graphs/(?P<graph_id>\d+)/nodes/(?P<node_id>\d+)/edges/(?P<edge_id>\d+)$','FuzzEd.api.edge', name='edge'),
