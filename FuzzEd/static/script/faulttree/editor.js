...
function(Editor, Factory, Canvas, FaulttreeGraph, Menus, AnalyticalMenus, FaulttreeConfig) {
    ...
    return Editor.extend({
        ...
        _loadGraphCompleted: function(readOnly) {
            ...
            this.analyticalProbabilityMenu = new AnalyticalMenus.AnalyticalProbabilityMenu(this.factory, this);
            this.simulatedProbabilityMenu  = new AnalyticalMenus.SimulatedProbabilityMenu(this.factory, this);
