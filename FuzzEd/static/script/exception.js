 ...
 * global namespace(!) and can be accessed from there. The exceptions are typed sub-prototypes of ECMAs builtin Error.
 *
 ...
 *
 * Inspired by Smalltalk and Python's way of declaring sort of abstract classes. Throw a SubclassResponsibility error
 * in methods that you want to be abstract respectively force to be overwritten.
 */
 ...
 * Class: ValueError
 *
 * Indicated that the value if of proper type but not within other certain constraints such as e.g. array bounds, range,
 * amount of values and so on.
 */
 ...
 * Class: Warning
 *
 * JavaScript does not support any kind of warning mechanism. Therefore, we facilitate exceptions instead. This Warning
 * sub-prototype can be extended at will and warning can be caught type safe.
 */
