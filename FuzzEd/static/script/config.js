define(['underscore'], function() {
    ...
    return {
         ...
         *      {String} ANALYTICAL_PROBABILITY_URL - Part of the sub-URL used for top event analytical probability API.
         *      {String} SIMULATED_PROBABILITY_URL  - Part of the sub-URL used for top event simulated probability API.
         ...
         *    {String} PROGRESS_INDICATOR_SINGLE   - The nav entry containing the progress indicator for a single job.
         ...
         *
         *      {String} LABEL_OVERLAY_ID         - The jsPlumb-internally used overlay ID for label.js accesses
         */
        JSPlumb: {
         ...
         *                            (needed for some hacks, see XXX remarks).
         */
        Keys: {
            EDGE:       'edge',
            NODE:       'node',
         ...
         *
         * Constants:
         *      {Number} SUCCESS_FLASH_DELAY       - Delay in ms before the progress indicator is hidden on success.
         *      {Number} ERROR_FLASH_DELAY         - Delay in ms before the progress indicator is hidden on error.
         ...
         *
         *      {String} EXPORT_PROGRESS_MESSAGE   - The message displayed when exporting the graph. The file name will
