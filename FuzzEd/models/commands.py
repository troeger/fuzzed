...
class Command(models.Model):
    ...
    def do(self):
        ...
        Stub for the commands do behaviour. Must be overwritten in subclasses.
    ...
    def undo(self):
        ...
        Stub for the commands undo behaviour. Must be overwritten in subclasses.
...
class ChangeNode(Command):
    ...
    def create_from(cls, graph_id, node_id, updated_properties):
        ...
        Parameters:
         ...
         {str] node_id    - the client id(!) of the node' property changed
